...
const { formRef, form: reservationForm, loading, handleSubmit } = useForm<CreateReservationForm>({
  ...
  onSubmit: async (values) => {
    ...
    await reservationApi.createReservation(values);
